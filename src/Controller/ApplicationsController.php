...
public function pdf($id = null)
{
    ...
    $this->viewBuilder()->setOption('pdfConfig', [
        ...
        'download' => true,
        'filename' => 'surat_permohonan_' . $id . '.pdf'
    ]);

    $application = $this->Applications->get($id, [
        'contain' => ['Programs', 'Semesters']
    ]);

    $this->set(compact('application'));

    return $this->render('pdf'); // Guna pdf.php
}
    ...
    public function index()
    {
        ...
        $this->set('total_applications_pending', $this->Applications->find()->where(['Status' => 'Pending'])->count());
        $this->set('total_applications_approved', $this->Applications->find()->where(['Status' => 'Approved'])->count());
        $this->set('total_applications_rejected', $this->Applications->find()->where(['Status' => 'Rejected'])->count());
    ...
    public function view($id = null)
    {
        ...
        $application = $this->Applications->get($id, contain: ['Programs', 'Semesters']);
        $this->set(compact('application'));
...
public function add()
{
    ...
    $this->set(compact('application', 'programs', 'semesters'));
}
...
public function changeStatus($id = null, $newStatus = null)
{
    ...
    if (!in_array($newStatus, ['Approved', 'Rejected'])) {
        ...
        return $this->redirect(['action' => 'approval']);
    }

    $application->Status = $newStatus;

    if ($this->Applications->save($application)) {
        $this->Flash->success("Application has been $newStatus.");
    } else {
        $this->Flash->error('Could not update application status.');
    }
